...
import { TravelPage } from './pages/curious/Travel'
import { ContactPage } from './pages/recruiters/Contact'
import { ExperiencePage } from './pages/recruiters/Experience'
import { BiteMatchPage } from './pages/recruiters/projects/BiteMatch'
import { ZlGamsatPage } from './pages/recruiters/projects/ZlGamsat'
        ...
        <Routes>
          <Route element={<AppShell />}>
            ...
            <Route
              ...
              element={<Navigate to="/recruiters/projects/zl-gamsat" replace />}
            />
            <Route
              path="recruiters/projects/zl-gamsat"
              element={<ZlGamsatPage />}
            />
            <Route
              path="recruiters/projects/bitematch"
              element={<BiteMatchPage />}
            />
            ...
            <Route path="curious/travel" element={<TravelPage />} />
